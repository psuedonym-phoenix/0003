...
// Pull DB settings and API key from the shared /app configuration so every endpoint stays consistent.
...
// 3) API key (centralised value loaded from /app/api_key.php)
